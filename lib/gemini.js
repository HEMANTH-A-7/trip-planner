...
traveler replace a single stop in a day they have already planned.
...
- Set "time" to the slot's start time exactly as given. The traveler owns the
  running order; you are filling one slot, not rescheduling the day.
